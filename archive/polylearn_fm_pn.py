...
pyximport.install()
import sys
sys.path.append('/media/adamsmith/Storage2/Downloads/Hyperband/zygmuntz_hyperband/polylearn')
sys.path.append('/media/adamsmith/Storage2/Downloads/Hyperband/zygmuntz_hyperband/polylearn/polylearn')
